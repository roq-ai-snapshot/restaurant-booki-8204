  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Restaurant Booking Engine, we streamline your dining experience. Reserve your tables, manage reservations and menus, all in one place. Simplifying restaurant management, one booking at a time."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Restaurant Booking Engine, we streamline your dining experience. Reserve your tables, manage reservations and menus, all in one place. Simplifying restaurant management, one booking at a time.`}
            </Text>
            <Box
